...
public class Propiedades {
	...
	public String leerPropiedades() {
		...
		try {
			...
			linea += "Numero de parrafos" + prop.getProperty("NumeroDeParrafos") + "\n";
		} catch (IOException e) {
			return null;
		}
		return linea;
	...
	public int leerParrafosPropeties() {
		...
		try {
			...
			// obtener las propiedades definidas
			prop.list(System.out);
			numeroParrafos = Integer.parseInt(prop.getProperty("NumeroDeParrafos"));
		} catch (IOException e) {
			return 0;
		}
	...
	public int leerEstrofasPropeties() {
